  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        <p className="animate-fade-up-delay text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-3 leading-relaxed">
        ...
        <p className="animate-fade-up-delay mb-10 text-sm font-semibold tracking-wide text-primary">
          100% free access — start learning with no paywall.
        </p>
